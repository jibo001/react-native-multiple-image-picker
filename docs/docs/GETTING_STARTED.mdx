...
Install [@jibo001/react-native-multiple-image-picker](https://www.npmjs.com/package/@jibo001/react-native-multiple-image-picker) through npm:
...
```bash
yarn add @jibo001/react-native-multiple-image-picker
...
```bash
npx expo install @jibo001/react-native-multiple-image-picker
