...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    ...
    Text toCpp() const {
      ...
      static const auto fieldAddMore = clazz->getField<jni::JString>("addMore");
      jni::local_ref<jni::JString> addMore = this->getFieldValue(fieldAddMore);
      return Text(
        ...
        addMore != nullptr ? std::make_optional(addMore->toStdString()) : std::nullopt
      );
    }
  ...
  public:
    ...
    static jni::local_ref<JText::javaobject> fromCpp(const Text& value) {
      return newInstance(
        ...
        value.addMore.has_value() ? jni::make_jstring(value.addMore.value()) : nullptr
      );
    }
  };
