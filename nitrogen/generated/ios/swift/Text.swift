...
public extension Text {
   ...
   */
  init(finish: String?, original: String?, preview: String?, edit: String?, addMore: String?) {
    self.init({ () -> bridge.std__optional_std__string_ in
      ...
      if let __unwrappedValue = addMore {
        return bridge.create_std__optional_std__string_(std.string(__unwrappedValue))
      } else {
        return .init()
      }
  ...
  var addMore: String? {
    ...
    get {
      return { () -> String? in
        if let __unwrapped = self.__addMore.value {
          return String(__unwrapped)
        } else {
          return nil
        }
    ...
    @inline(__always)
    set {
      self.__addMore = { () -> bridge.std__optional_std__string_ in
        if let __unwrappedValue = newValue {
          return bridge.create_std__optional_std__string_(std.string(__unwrappedValue))
        } else {
          return .init()
