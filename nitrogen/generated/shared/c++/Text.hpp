...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    ...
    std::optional<std::string> addMore     SWIFT_PRIVATE;

  public:
    Text() = default;
    explicit Text(std::optional<std::string> finish, std::optional<std::string> original, std::optional<std::string> preview, std::optional<std::string> edit, std::optional<std::string> addMore): finish(finish), original(original), preview(preview), edit(edit), addMore(addMore) {}
  };
  ...
  struct JSIConverter<Text> final {
    static inline Text fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return Text(
        ...
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, "addMore"))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const Text& arg) {
      ...
      obj.setProperty(runtime, "addMore", JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.addMore));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, "addMore"))) return false;
      return true;
    }
  };
